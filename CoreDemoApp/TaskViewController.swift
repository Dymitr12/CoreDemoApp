...
//  CoreDemoApp
//
//  Created by Dymitr on 18.04.2022.
//
...
class TaskViewController: UIViewController {
    ...
    private lazy var saveButton: UIButton = {
        createButton(withTitle: "Save TTask", andColor: UIColor(red: 21/255, green: 101/255, blue: 192/255, alpha: 194/255), action: UIAction { _ in
            self.save()
        })
    }()
    
    private lazy var cancelButton: UIButton = {
        createButton(withTitle: "Cancel", andColor: .red, action: UIAction { _ in
